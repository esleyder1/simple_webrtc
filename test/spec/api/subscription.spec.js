...
import { Subscriber, SubscriptionState } from "../../../lib/api/index.js";
import { C, Dialog, NonInviteClientTransaction, ReSubscribeUserAgentServer, Timers, UserAgentClient } from "../../../lib/core/index.js";
...
describe("API Subscription", () => {
    ...
    let subscriber;
    let subscription;
    let subscriptionStateSpy;
    let notifierDialog;
    let receivedEvent;
    let receivedExpires;
    const subscriptionDelegateMock = jasmine.createSpyObj("SubscriptionDelegate", [
        "onNotify"
    ]);
    subscriptionDelegateMock.onNotify.and.callFake((notification) => {
        notification.accept();
    });
    const event = "foo";
                ...
                beforeEach(async () => {
                    ...
                    bob.userAgent.delegate = {
                        onSubscribeRequest: (request) => {
                            ...
                            notifierDialog.receiveRequest = (message) => {
