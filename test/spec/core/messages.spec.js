...
import { IncomingRequestMessage as IncomingRequest, IncomingResponseMessage as IncomingResponse, OutgoingRequestMessage as OutgoingRequest } from "../../../lib/core/index.js";
    ...
    describe("IncomingRequest", () => {
        ...
        describe(".parseHeader", () => {
            ...
            it("returns the already parsed header if it exists", () => {
                ...
                expect(Grammar.parse.calls.count()).toEqual(1);
