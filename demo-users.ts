...
const domain = "asterisk.ccpml.com";

export const nameAlice = "Alice";
export const uriAlice = "User1:12345." + token + "@" + domain;
export const webSocketServerAlice = "ws://asterisk.ccpml.com:8089/ws";

export const nameBob = "Bob";
export const uriBob = "sip:bob." + token + "@" + domain;
export const webSocketServerBob = "ws://asterisk.ccpml.com:8089/ws";
